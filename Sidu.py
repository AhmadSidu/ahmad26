#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To ahmadsidu
...
CorrectUsername = "A4Ahmad"
CorrectPassword = "S4Sidu"
...
def login():
	...
	try:
		...
		jalan(' \033[1;92m     Notice:тШЮ \033[1;93mStay Home Stay Safe Save lives Save Pakistan' )
                ...
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97mNever tell a lie ' )
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97mDont use hacking for threats ' )
		jalan(' \033[1;92m     Notice:тШЮ \033[1;97mbhai shampoo thoda use kia kar' )
                jalan(' \033[1;92m    Warning:тШЮ \033[1;95mCloning k liay sirf Public Iink use krienn' )
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mA4Ahmad\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
		...
		if 'save-device' in url:
			try:
				...
				print"\n\x1b[1;91mBsdk pehly net to thik karly"
				keluar()
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:ahmad_sidu
	print logo
	...
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mAhmadSidu\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mA4Ahmad\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
		try:
	...
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mAhmadSidu\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	jalan(' \033[1;93m .......................Ruko Zara Sabar Karo....................... ')
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mAhmadSidu\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	
			
	def main(arg):96mA4Ahmad
		global cekpoint,oks
		user = arg
		try:
			os.mkdir('out')
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By baloch-hacker--тАвтЧИтАв---┬╗" #Dev:sidu_hacker
